...
~~~ sh
sudo apt-get install cmake clang python3 python3-sphinx libuv1-dev alsa-utils libasound2-dev libcurl4-openssl-dev libmpdclient-dev libcairo2-dev libiw-dev
~~~
